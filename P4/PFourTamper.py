...
def main(anchor_position, block_size):
    ...
    transparent_image = "C:\\Users\\Jasper\\Desktop\\Pps\\P4\\original\\strawberry-fields-frame.png"
    tran_misc = misc.imread(transparent_image)
    tran = tran_misc.tolist()

    gray_image = "C:\\Users\\Jasper\\Desktop\\Pps\\P4\\original\\strawberry-fields-frame.bmp"
