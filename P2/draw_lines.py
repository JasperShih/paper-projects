...
plt.plot(line_bbp1, line_PSNR1, "r.:", linewidth = 2)
plt.plot(line_bbp2, line_PSNR2, "b.:", linewidth = 2)
plt.plot(line_bbp3, line_PSNR3, "g.:", linewidth = 2)
plt.plot(line_bbp4, line_PSNR4, "k.:", linewidth = 2)
